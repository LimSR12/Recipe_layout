...
const Recipe = () => {
  ...
  // const [categoryList, setCategoryList] = useState('cake');
  // const addMuffin = () => {
  //   setCategoryList('muffin');
  // }
  // const addCake = () => {
  //   setCategoryList('cake');
  // }
  // const addTart = () => {
  //   setCategoryList('tart');
  // }
  ...
  return (
    ...
    <>
      <div>
        <p className='text-center font-bold text-orange-500 text-xl mt-10 mb-10'>카테고리</p>
